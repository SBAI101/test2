<template>
  ...
  >
    <defs v-if="locale === 'en'">
      <linearGradient id="us-white" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#FFFFFF" offset="0%"/>
        <stop stop-color="#F0F0F0" offset="100%"/>
      </linearGradient>
      <linearGradient id="us-red" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#D02F44" offset="0%"/>
        <stop stop-color="#B12537" offset="100%"/>
      </linearGradient>
      <linearGradient id="us-blue" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#46467F" offset="0%"/>
        <stop stop-color="#3C3C6D" offset="100%"/>
      </linearGradient>
    </defs>
    <defs v-else>
      <linearGradient id="fr-white" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#FFFFFF" offset="0%"/>
        <stop stop-color="#F0F0F0" offset="100%"/>
      </linearGradient>
      <linearGradient id="fr-red" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#F44653" offset="0%"/>
        <stop stop-color="#EE2A39" offset="100%"/>
      </linearGradient>
      <linearGradient id="fr-blue" x1="50%" y1="0%" x2="50%" y2="100%">
